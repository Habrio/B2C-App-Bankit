...
const CashJourney: React.FC<CashJourneyProps> = ({ onClose, onSuccess }) => {
        ...
        return (
            <div className="bg-white h-full flex flex-col p-6">
                ...
                <main className="flex-grow flex flex-col justify-center text-center">
                    <h1 className="text-2xl font-bold text-gray-900">Get Cash Instantly</h1>
                    <p className="text-gray-600 mt-2 text-sm">Up to ₹2,00,000 directly in your bank account.</p>
    ...
    const SelectionScreen = () => (
        <div className="bg-white h-full flex flex-col p-6">
            <header className="flex-shrink-0 flex items-center">
                 ...
                 <h2 className="text-lg font-bold">Select Loan Details</h2>
            </header>
            <main className="flex-grow flex flex-col justify-center space-y-8">
                <div>
                 ...
                 <div>
                    <div className="flex justify-between items-end mb-2">
                        ...
                        <span className="font-bold text-xl text-primary">{tenure} months</span>
                    </div>
                ...
                <div className="text-center bg-gray-50 rounded-lg p-4">
                    <p className="text-sm text-gray-600">Your EMI will be</p>
                    <p className="font-bold text-2xl text-gray-800">₹{emi.toLocaleString('en-IN')}<span className="text-sm font-normal">/month</span></p>
                </div>
            </main>
             <footer className="flex-shrink-0">
    ...
    const ProcessingScreen = () => (
        <div className="bg-white h-full flex flex-col items-center justify-center p-6 text-center">
            ...
            <h2 className="text-xl font-bold mt-8">Reviewing Application</h2>
            <p className="text-gray-600 text-sm">Please wait while we check your eligibility. This won't take long.</p>
        </div>
    );
    ...
    const OfferScreen = () => (
         <div className="bg-white h-full flex flex-col p-6 text-center">
            ...
            <main className="flex-grow flex flex-col justify-center">
                ...
                <p className="text-gray-600 mt-2 text-sm">Your loan has been approved.</p>
                <div className="my-8 bg-gray-50 border border-gray-200 rounded-xl p-6 space-y-4">
                     <div>
                        ...
                        <p className="font-bold text-xl text-gray-800">₹{amount.toLocaleString('en-IN')}</p>
                    </div>
                     <div>
                        <p className="text-gray-500 text-xs">Monthly EMI</p>
                        <p className="font-bold text-xl text-gray-800">₹{emi.toLocaleString('en-IN')} for {tenure} months</p>
                    </div>
                </div>
