    ...
    return (
        <div className="space-y-4">
            <div className="bg-white p-4 rounded-2xl shadow-sm">
                <p className="font-semibold">Tax Progress</p>
                <p className="text-sm text-gray-500">Track deductible investments & expenses for hassle-free filing</p>
                <div className="my-4">
                    <p className="text-2xl font-bold">{progressPercent.toFixed(0)}% <span className="text-lg font-normal">completed</span></p>
             ...
             <div className="bg-white p-4 rounded-2xl shadow-sm">
                 <p className="font-semibold">Bank Interest</p>
...
const LifestyleContent: React.FC = () => {
    ...
    return (
         <div className="space-y-4">
             <div className="bg-white p-4 rounded-2xl shadow-sm">
                <p className="font-semibold mb-3">Recurring Transactions</p>
                <div className="space-y-3">
              ...
              <div className="bg-white p-4 rounded-2xl shadow-sm">
                <p className="font-semibold">Spending Trend</p>
                <p className="text-sm text-gray-500 mb-4">This month you've spent 69% less than the last month</p>
                <div className="space-y-2">
                    <div>
                        <p className="font-bold text-lg">₹1.98L <span className="text-sm font-normal text-gray-500">August</span></p>
                        <ProgressBar value={1.98} max={6.32} color="#002393" />
                    </div>
                    <div>
                        <p className="font-bold text-lg">₹6.32L <span className="text-sm font-normal text-gray-500">July</span></p>
            ...
            <main className="flex-grow overflow-y-auto px-4 pb-4">
                 <div className="bg-white p-2 rounded-lg shadow-sm mb-4">
                    <button className="w-full flex justify-between items-center text-left">
                        <span className="font-semibold">Financial Year 2025-26</span>
