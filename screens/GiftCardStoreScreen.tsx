    ...
    return (
        <div className="h-full bg-gray-900 text-white flex flex-col">
             <header className="p-4 pt-6 flex-shrink-0 z-10 sticky top-0 bg-gray-900 flex items-center justify-between">
                ...
                <h1 className="text-xl font-bold">Gift Card Store</h1>
            ...
            <div className="flex-grow overflow-y-auto no-scrollbar">
                <div className="px-4 pb-4">
                    <h1 className="text-2xl font-bold">use coins to save</h1>
                    <p className="text-gray-400">on 200+ brands</p>
                </div>
                 <div className="px-4 sticky top-[72px] bg-gray-900 py-2 z-10">
                    <button onClick={onSearch} className="w-full flex items-center space-x-3 text-left bg-gray-800 rounded-lg p-3">
                        ...
                        <span className="text-gray-400">search for brands</span>
                    </button>
                 </div>
                
                {/* Handpicked Deals */}
                <div className="py-4">
                    <h2 className="font-bold text-lg px-4 mb-3">handpicked deals</h2>
